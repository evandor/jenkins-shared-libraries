            ...
            stage ('Copy dockerRun to target...') {
                steps{
                    sshagent(credentials : ['sailor1']) {
                        sh "ssh -o StrictHostKeyChecking=no ${user}@ec2-34-246-151-3.eu-west-1.compute.amazonaws.com uptime"
                        sh "ssh -o StrictHostKeyChecking=no ${user}@ec2-34-246-151-3.eu-west-1.compute.amazonaws.com whoami"
